...
import { ConsoleLogger as Logger, ClientDevice, Credentials, Signer, Hub, transferKeyToLowerCase, transferKeyToUpperCase, } from '@aws-amplify/core';
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, putEvents({ credentials: credentials, region: region }, eventParams)];
                    case 2:
                        data = _h.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, updateEndpoint({ credentials: credentials, region: region }, update_params)];
                    case 2:
                        data = _b.sent();
