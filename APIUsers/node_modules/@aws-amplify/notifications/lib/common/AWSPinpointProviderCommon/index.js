            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, pinpoint_1.putEvents({ credentials: credentials, region: region }, input)];
                    case 3:
                        _e.sent();
                        return [3 /*break*/, 5];
                    case 4:
                ...
                return tslib_1.__generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, pinpoint_1.updateEndpoint({ credentials: credentials, region: region }, input)];
                        case 3:
                            _f.sent();
